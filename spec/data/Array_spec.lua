...
describe("p4lua.data.Array", function()
    ...
    describe("foldl", function()
        ...
        it("stops at nil", function()
            assert.equals(0, Array.foldl(ff, 0, { nil, 2, 3 }))
            assert.equals(-1, Array.foldl(ff, 0, { 1, nil, 3 }))
            assert.equals(-3, Array.foldl(ff, 0, { 1, 2, nil }))
        end)
    ...
    describe("foldr", function()
        ...
        it("stops at nil", function()
            assert.equals(10, Array.foldr(ff, 10, { nil, 2, 3 }))
            assert.equals(-9, Array.foldr(ff, 10, { 1, nil, 3 }))
            assert.equals(9, Array.foldr(ff, 10, { 1, 2, nil }))
        end)
